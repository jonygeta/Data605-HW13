---
title: "DATA 605 Week 13 Homework (Test Builder)"
...
\end{split}
$$
Final Findings : The definite integral of the function on interval $[1, e^6]$ is $1$. Additionally, if $x>0$, then $f(x)>0$, so for this interval $f(x)>0$. As long as $f(x)=0$ outside of the given interval, due to this we can can finally agree that it is  **is a probability density function**. 